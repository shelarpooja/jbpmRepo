<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("num");
					i++;
...
<div id="container">
	<div id="header">
		New Process Instance: /Management/src/main/resources/sdc/management.xyz
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="num" type="text" class="textbox" id="num" value="" />
                            		</div>
