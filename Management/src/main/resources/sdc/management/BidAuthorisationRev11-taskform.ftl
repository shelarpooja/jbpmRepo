<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("QtyToBeProcducedDO");
					i++;
					myInputs[i] = document.getElementById("CostPerUnitRemarkDO");
					i++;
					myInputs[i] = document.getElementById("BidRevAmtDO");
					i++;
					myInputs[i] = document.getElementById("BidRevRemarkDO");
					i++;
					myInputs[i] = document.getElementById("ActualDateDO");
					i++;
					myInputs[i] = document.getElementById("NewCostPerUnitDO");
					i++;
					myInputs[i] = document.getElementById("bidAuthRemarkDO");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid QtyToBeProcducedDO");
							myInputs[j].focus();
							return false;
						}
					...
					j++;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid BidRevAmtDO");
							myInputs[j].focus();
							return false;
						}
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid BidRevRemarkDO");
							myInputs[j].focus();
							return false;
						}
					...
					j++;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid NewCostPerUnitDO");
							myInputs[j].focus();
							return false;
						}
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid bidAuthRemarkDO");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: EnquiryManagement.BidAuthorisationRev11
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[ProductionManager]]></div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">BidRevAmtDI</label>
                            		<div class="div_checkbox">
                              		${BidRevAmtDI}
                            		</div>
                            		<label for="name">BidRevRemarkDI</label>
                            		<div class="div_checkbox">
                              		${BidRevRemarkDI}
                            		</div>
                            		...
                            		<label for="name">NewCostPerUnitDI</label>
                            		<div class="div_checkbox">
                              		${NewCostPerUnitDI}
                            		</div>
                            		<label for="name">bidAuthRemarkDI</label>
                            		<div class="div_checkbox">
                              		${bidAuthRemarkDI}
                            		</div>
                            		<label for="name">Description</label>
                            		<div class="div_checkbox">
                              		<![CDATA[Authorise Bid Proposal]]>
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">QtyToBeProcducedDO</label>
                            		<div class="div_texbox">
                              		<input name="QtyToBeProcducedDO" type="text" class="textbox" id="QtyToBeProcducedDO" value="${QtyToBeProcducedDO}" />
                            		</div>
                            		...
                            		<label for="name">BidRevAmtDO</label>
                            		<div class="div_texbox">
                              		<input name="BidRevAmtDO" type="text" class="textbox" id="BidRevAmtDO" value="${BidRevAmtDO}" />
                            		</div>
              	
                            		<label for="name">BidRevRemarkDO</label>
                            		<div class="div_texbox">
                              		<input name="BidRevRemarkDO" type="text" class="textbox" id="BidRevRemarkDO" value="${BidRevRemarkDO}" />
                            		</div>
                            		...
                            		<label for="name">NewCostPerUnitDO</label>
                            		<div class="div_texbox">
                              		<input name="NewCostPerUnitDO" type="text" class="textbox" id="NewCostPerUnitDO" value="${NewCostPerUnitDO}" />
                            		</div>
              	
                            		<label for="name">bidAuthRemarkDO</label>
                            		<div class="div_texbox">
                              		<input name="bidAuthRemarkDO" type="text" class="textbox" id="bidAuthRemarkDO" value="${bidAuthRemarkDO}" />
                            		</div>
