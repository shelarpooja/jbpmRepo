<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("BidRevCheckDO");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid BidRevCheckDO");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: EnquiryManagement.bidRevision9
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[EngineeringHead]]></div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">BidRevCheckDI</label>
                            		<div class="div_checkbox">
                              		${BidRevCheckDI}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">BidRevCheckDO</label>
                            		<div class="div_checkbox">
                              		<input name="BidRevCheckDO" type="checkbox" class="checkbox" id="BidRevCheckDO" value="${BidRevCheckDO}" />
                            		</div>
