<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("MaintHeadRemarkDI");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid MaintHeadRemarkDI");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: Machine Management.3b.OtherRepairingSection
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">MaintHeadRemarkDI</label>
                            		<div class="div_texbox">
                              		<input name="MaintHeadRemarkDI" type="text" class="textbox" id="MaintHeadRemarkDI" value="${MaintHeadRemarkDI}" />
                            		</div>
