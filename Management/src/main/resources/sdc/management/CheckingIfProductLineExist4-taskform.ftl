<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("ProctLineExistDO");
					i++;
		...
		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid ProctLineExistDO");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: EnquiryManagement.CheckingIfProductLineExist4
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">ProctLineExistDI</label>
                            		<div class="div_checkbox">
                              		${ProctLineExistDI}
                            		</div>
                            		...
                            		<div class="div_checkbox">
                              		<![CDATA[Determining Product capacity & Actual Date]]>
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">ProctLineExistDO</label>
                            		<div class="div_checkbox">
                              		<input name="ProctLineExistDO" type="checkbox" class="checkbox" id="ProctLineExistDO" value="${ProctLineExistDO}" />
                            		</div>
