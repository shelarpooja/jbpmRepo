<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("SupervisorStatusDO");
					i++;
					myInputs[i] = document.getElementById("SupervisorRemarksDO");
					i++;
					myInputs[i] = document.getElementById("MaintHeadRemarkDO");
					i++;
					myInputs[i] = document.getElementById("RepairCommentDO");
					i++;
					myInputs[i] = document.getElementById("RepairActionsDO");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid SupervisorStatusDO");
							myInputs[j].focus();
							return false;
						}
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid SupervisorRemarksDO");
							myInputs[j].focus();
							return false;
						}
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid MaintHeadRemarkDO");
							myInputs[j].focus();
							return false;
						}
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid RepairCommentDO");
							myInputs[j].focus();
							return false;
						}
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid RepairActionsDO");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: Machine Management.4.Supervision
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[ProdSupervisor]]></div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">SupervisorStatusDI</label>
                            		<div class="div_checkbox">
                              		${SupervisorStatusDI}
                            		</div>
                            		<label for="name">SupervisorRemarksDI</label>
                            		<div class="div_checkbox">
                              		${SupervisorRemarksDI}
                            		</div>
                            		<label for="name">MaintHeadRemarkDI</label>
                            		<div class="div_checkbox">
                              		${MaintHeadRemarkDI}
                            		</div>
                            		<label for="name">RepairCommentDI</label>
                            		<div class="div_checkbox">
                              		${RepairCommentDI}
                            		</div>
                            		<label for="name">RepairActionsDI</label>
                            		<div class="div_checkbox">
                              		${RepairActionsDI}
                            		</div>
                            		<label for="name">Description</label>
                            		<div class="div_checkbox">
                              		<![CDATA[Supervision of Repaired Machine]]>
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">SupervisorStatusDO</label>
                            		<div class="div_texbox">
                              		<input name="SupervisorStatusDO" type="text" class="textbox" id="SupervisorStatusDO" value="${SupervisorStatusDO}" />
                            		</div>
              	
                            		<label for="name">SupervisorRemarksDO</label>
                            		<div class="div_texbox">
                              		<input name="SupervisorRemarksDO" type="text" class="textbox" id="SupervisorRemarksDO" value="${SupervisorRemarksDO}" />
                            		</div>
              	
                            		<label for="name">MaintHeadRemarkDO</label>
                            		<div class="div_texbox">
                              		<input name="MaintHeadRemarkDO" type="text" class="textbox" id="MaintHeadRemarkDO" value="${MaintHeadRemarkDO}" />
                            		</div>
              	
                            		<label for="name">RepairCommentDO</label>
                            		<div class="div_texbox">
                              		<input name="RepairCommentDO" type="text" class="textbox" id="RepairCommentDO" value="${RepairCommentDO}" />
                            		</div>
              	
                            		<label for="name">RepairActionsDO</label>
                            		<div class="div_texbox">
                              		<input name="RepairActionsDO" type="text" class="textbox" id="RepairActionsDO" value="${RepairActionsDO}" />
                            		</div>
