<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("ValidRequestDO");
					i++;
		...
		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid ValidRequestDO");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: EnquiryManagement.ValidatingEnquiry2
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[SalesManager]]></div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">StartDI</label>
                            		<div class="div_checkbox">
                              		${StartDI}
                            		</div>
                            		<label for="name">Description</label>
                            		<div class="div_checkbox">
                              		<![CDATA[Validating the Enquity Request for further process]]>
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">ValidRequestDO</label>
                            		<div class="div_checkbox">
                              		<input name="ValidRequestDO" type="checkbox" class="checkbox" id="ValidRequestDO" value="${ValidRequestDO}" />
                            		</div>
